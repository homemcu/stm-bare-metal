...
{
	uint32_t start;
	start = ((DWT_Type *) (0xE0001000UL) )->CYCCNT;
	delay_us *= (SystemCoreClock / 1000000);
	while ((((DWT_Type *) (0xE0001000UL) )->CYCCNT - start) < delay_us);
}
...
static void SetSysClock(void)
{
	...
	while (!(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CR & (0x1UL << (17U))));

	
	((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR |= (0x1UL << (28U));
	
	
	((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR |= 0x00004000U | 0x00008000U;


	
	((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR |= 0x00000000U;

	
	((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR |= 0x00001000U;
	...
	((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR = (25 << (0U)) |
		           (192 << (6U)) |
		           (((2 >> 1) - 1) << (16U)) |
		           (4 << (24U)) |
		           (0x1UL << (22U));
	...
	while (!(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CR & (0x1UL << (25U))));

	
	
	((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->ACR = (0x1UL << (8U)) | (0x1UL << (9U)) | (0x1UL << (10U)) | 0x00000003U;

	
	((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR &= ~(0x3UL << (0U));
	((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR |= 0x00000002U;
	while ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR & (0x3UL << (2U))) != 0x00000008U);
}
...
void platform_init(void)
{
	...
	__NVIC_SetPriority(SysTick_IRQn, NVIC_EncodePriority(__NVIC_GetPriorityGrouping(), 0, 0));
	DWTInit();
}
