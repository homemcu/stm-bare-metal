...
static USB_OTG_GlobalTypeDef * const OTG  = (void*)(0x50000000UL + 0x000UL);
static USB_OTG_DeviceTypeDef * const OTGD = (void*)(0x50000000UL + 0x800UL);
static volatile uint32_t * const OTGPCTL  = (void*)(0x50000000UL + 0xE00UL);


inline static uint32_t* EPFIFO(uint32_t ep) {
    return (uint32_t*)(0x50000000UL + 0x1000UL + (ep << 12));
}

inline static USB_OTG_INEndpointTypeDef* EPIN(uint32_t ep) {
    return (void*)(0x50000000UL + 0x900UL + (ep << 5));
}

inline static USB_OTG_OUTEndpointTypeDef* EPOUT(uint32_t ep) {
    return (void*)(0x50000000UL + 0xB00UL + (ep << 5));
}

inline static void Flush_RX(void) {
    (OTG->GRSTCTL) = ((OTG->GRSTCTL) | ((0x1UL << (4U))));
    while(((OTG->GRSTCTL) & ((0x1UL << (4U)))) != 0);
}

inline static void Flush_TX(uint8_t ep) {
    (OTG->GRSTCTL) = (((OTG->GRSTCTL) & ~((0x1FUL << (6U)))) | ((((uint32_t)(ep) << (6U)) & (0x1FUL << (6U))) | (0x1UL << (5U))));
    while(((OTG->GRSTCTL) & ((0x1UL << (5U)))) != 0);
}

static uint32_t getinfo(void) {
    if (!(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR & (0x1UL << (7U)))) return ((1 << 0) | (0));
    if (!(OTGD->DCTL & (0x1UL << (1U)))) return ((1 << 0) | ((1 << 3) | (2 << 4)));
    return ((1 << 0) | ((1 << 3)));
}

static void ep_setstall(uint8_t ep, _Bool stall) {
    if (ep & 0x80) {
        ep &= 0x7F;
        ...
        if (_t & (0x1UL << (15U))) {
            if (stall) {
                ...
                (_t) = (((_t) & ~((0x1UL << (21U)))) | ((0x1UL << (28U)) | (0x1UL << (26U))));
            }
            EPIN(ep)->DIEPCTL = _t;
        }
    } else {
...
static _Bool ep_isstalled(uint8_t ep) {
    if (ep & 0x80) {
        ep &= 0x7F;
        return (EPIN(ep)->DIEPCTL & (0x1UL << (21U))) ? 1 : 0;
    } else {
        return (EPOUT(ep)->DOEPCTL & (0x1UL << (21U))) ? 1 : 0;
    }
}

static void enable(_Bool enable) {
    if (enable) {
         
        (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) | ((0x1UL << (7U))));
         
        while(((OTG->GRSTCTL) & ((0x1UL << (31U)))) == 0);
         
        (OTG->GUSBCFG) = (((OTG->GUSBCFG) & ~((0x1UL << (8U)) | (((uint32_t)(0x0F) << (10U)) & (0xFUL << (10U))))) | ((0x1UL << (30U)) | (((uint32_t)(0x06) << (10U)) & (0xFUL << (10U)))));
         
        OTG->GCCFG = (0x1UL << (21U));
         
        *OTGPCTL = 0;
         
        (OTGD->DCTL) = ((OTGD->DCTL) | ((0x1UL << (1U))));
         
        (OTGD->DCFG) = (((OTGD->DCFG) & ~((0x3UL << (24U)) | (0x3UL << (0U)))) | ((((uint32_t)(0) << (24U)) & (0x3UL << (24U))) | (((uint32_t)(0x03) << (0U)) & (0x3UL << (0U)))));
         
        OTG->GRXFSIZ = ((4 * 1 + 6) + ((512 / 4) + 1) + (4 * 2) + 1);
         
        OTG->DIEPTXF0_HNPTXFSIZ = ((4 * 1 + 6) + ((512 / 4) + 1) + (4 * 2) + 1) | (0x10 << 16);
         
        OTGD->DIEPMSK = (0x1UL << (0U));
        OTGD->DOEPMSK = (0x1UL << (3U));
         
        OTG->GINTMSK  = (0x1UL << (12U)) | (0x1UL << (13U)) |
                        (0x1UL << (19U)) | (0x1UL << (20U)) |
                        (0x1UL << (21U)) | (0x1UL << (15U)) |
                        (0x1UL << (11U)) | (0x1UL << (31U)) |
                        (0x1UL << (18U)) | (0x1UL << (4U));
        ...
        (OTG->GAHBCFG) = ((OTG->GAHBCFG) | ((0x1UL << (0U))));
    } else {
        if (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR & (0x1UL << (7U))) {
            (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2RSTR) = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2RSTR) | ((0x1UL << (7U))));
            (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2RSTR) = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2RSTR) & ~((0x1UL << (7U))));
            (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) & ~((0x1UL << (7U))));
        }
    }
...
static uint8_t connect(_Bool connect) {
    if (connect) {

 
        (OTG->GCCFG) = ((OTG->GCCFG) | ((0x1UL << (16U))));
        (OTGD->DCTL) = ((OTGD->DCTL) & ~((0x1UL << (1U))));
    } else {
        (OTGD->DCTL) = ((OTGD->DCTL) | ((0x1UL << (1U))));
        (OTG->GCCFG) = ((OTG->GCCFG) & ~((0x1UL << (16U))));
...
static void setaddr (uint8_t addr) {
    (OTGD->DCFG) = (((OTGD->DCFG) & ~((0x7FUL << (4U)))) | (addr << 4));
}
...
static _Bool set_tx_fifo(uint8_t ep, uint16_t epsize) {
...
static _Bool ep_config(uint8_t ep, uint8_t eptype, uint16_t epsize) {
    if (ep == 0) {
        ...
        EPIN(ep)->DIEPCTL = mpsize | (0x1UL << (27U));
         
        EPOUT(ep)->DOEPTSIZ = epsize | (1 << 29) | (1 << 19);
        EPOUT(ep)->DOEPCTL = mpsize | (0x1UL << (31U)) | (0x1UL << (26U));
        return 1;
    }
    if (ep & 0x80) {
        ep &= 0x7F;
        ...
        if (eptype & 0x04) {
            if (!set_tx_fifo(ep, epsize << 1)) return 0;
        } else {
            if (!set_tx_fifo(ep, epsize)) return 0;
        }
        ...
        case 0x01:
        case 0x01 | 0x04:
            epi->DIEPCTL = (0x01 << 18) | (0x1UL << (15U)) |
                           (0x1UL << (28U)) |
                           (ep << 22) | epsize;
            break;
        case 0x02:
        case 0x02 | 0x04:
            epi->DIEPCTL = (0x1UL << (27U)) | (0x1UL << (15U)) |
                            (0x02 << 18) | (0x1UL << (28U)) |
                            (ep << 22) | epsize;
            break;
        default:
        ...
        case 0x01:
        case 0x01 | 0x04:
            epo->DOEPCTL = (0x1UL << (26U)) |
                           (0x1UL << (31U)) | (0x1UL << (15U)) |
                           (0x01 << 18) | epsize;
            break;
        case 0x02 | 0x04:
        case 0x02:
            epo->DOEPCTL = (0x1UL << (28U)) | (0x1UL << (26U)) |
                           (0x1UL << (31U)) | (0x1UL << (15U)) |
                           (0x02 << 18) | epsize;
            break;
        default:
...
static void ep_deconfig(uint8_t ep) {
    ...
    (epi->DIEPCTL) = ((epi->DIEPCTL) & ~((0x1UL << (15U))));
     
    Flush_TX(ep);
     
    if ((epi->DIEPCTL & (0x1UL << (31U))) && (ep != 0)) {
        epi->DIEPCTL = (0x1UL << (30U));
    }
    ...
    (epo->DOEPCTL) = ((epo->DOEPCTL) & ~((0x1UL << (15U))));
    if ((epo->DOEPCTL & (0x1UL << (31U))) && (ep != 0)) {
        epo->DOEPCTL = (0x1UL << (30U));
    }
    epo->DOEPINT = 0xFF;
}
...
static int32_t ep_read(uint8_t ep, void* buf, uint16_t blen) {
    ...
    if (!(OTG->GINTSTS & (0x1UL << (4U)))) return -1;
    ep &= 0x7F;
    if ((OTG->GRXSTSR & (0xFUL << (0U))) != ep) return -1;
     
    len = (((uint32_t)(OTG->GRXSTSP) & (0x7FFUL << (4U))) >> (4U));
...
static int32_t ep_write(uint8_t ep, void *buf, uint16_t blen) {
    ...
    if (ep != 0 && epi->DIEPCTL & (0x1UL << (31U))) {
        return -1;
    }
    epi->DIEPTSIZ = 0;
    epi->DIEPTSIZ = (1 << 19) + blen;
    (epi->DIEPCTL) = (((epi->DIEPCTL) & ~((0x1UL << (21U)))) | ((0x1UL << (31U)) | (0x1UL << (26U))));
...
static uint16_t get_frame (void) {
    return (((uint32_t)(OTGD->DSTS) & (0x3FFFUL << (8U))) >> (8U));
}
...
static void evt_poll(usbd_device *dev, usbd_evt_callback callback) {
    ...
    while (1) {
        ...
        if (_t & (0x1UL << (12U))) {
            OTG->GINTSTS = (0x1UL << (12U));
            for (uint8_t i = 0; i < 4; i++ ) {
                ep_deconfig(i);
            }
            Flush_RX();
            continue;
        } else if (_t & (0x1UL << (13U))) {
            OTG->GINTSTS = (0x1UL << (13U));
            evt = 0;
        } else if (_t & (0x1UL << (18U))) {
            for (;; ep++) {
                USB_OTG_INEndpointTypeDef* epi = EPIN(ep);
                if (ep >= 4) return;
                if (epi->DIEPINT & (0x1UL << (0U))) {
                    (epi->DIEPINT) = ((epi->DIEPINT) | ((0x1UL << (0U))));
                    evt = 4;
                    ep |= 0x80;
                    break;
                }
            ...
            _t = OTG->GRXSTSR;
            ep = _t & (0xFUL << (0U));
            switch ((((uint32_t)(_t) & (0xFUL << (17U))) >> (17U))) {
            case 0x02:   
                evt = 5;
                break;
            case 0x06:   
                 
                if (EPIN(ep)->DIEPTSIZ & (0x3FFUL << (19U))) {
                    Flush_TX(ep);
                }
                evt = 6;
                break;
            case 0x03:   
            case 0x04:   
                (EPOUT(ep)->DOEPCTL) = ((EPOUT(ep)->DOEPCTL) | ((0x1UL << (26U)) | (0x1UL << (31U))));
            default:
                 
                OTG->GRXSTSP;
                continue;
            }
        } else if (_t & (0x1UL << (11U))) {
            evt = 2;
            OTG->GINTSTS = (0x1UL << (11U));
        } else if (_t & (0x1UL << (31U))) {
            OTG->GINTSTS = (0x1UL << (31U));
            evt = 3;
        } else if (_t & (0x1UL << (19U))) {
            for (;; ep++) {
                USB_OTG_OUTEndpointTypeDef* epi = EPOUT(ep);
                if (ep >= 4) break;
                if (epi->DOEPINT & (0x1UL << (0U))) {
                    epi->DOEPINT = (0x1UL << (0U));
                    break;
                } else if (epi->DOEPINT & (0x1UL << (3U))) {
                    epi->DOEPINT = (0x1UL << (3U));
                    break;
                } else if (epi->DOEPINT & (0x1UL << (4U))) {
                    epi->DOEPINT = (0x1UL << (4U));
                    break;
                }
            }
            continue;
        } else if (_t & (0x1UL << (20U))) {
            for (;; ep++) {
                USB_OTG_INEndpointTypeDef* epi = EPIN(ep);
                if (ep >= 4) break;
                uint32_t diepctl = epi->DIEPCTL;
                if (((diepctl & (0x3UL << (18U))) == (0x1UL << (18U))) && 
                    ((diepctl & (0x1UL << (31U))) != 0)) {
                    epi->DIEPCTL |= (0x1UL << (30U));
                    break;
                }
            }
            OTG->GINTSTS = (0x1UL << (20U));
            return;
        } else if (_t & (0x1UL << (21U))) {
             OTG->GINTSTS = (0x1UL << (21U));
             return;
        } else if (_t & (0x1UL << (15U))) {
            for (;; ep++) {
                USB_OTG_INEndpointTypeDef* epi = EPIN(ep);
                USB_OTG_OUTEndpointTypeDef* epo = EPOUT(ep);
                if (ep >= 4) break;
                if ((epo->DOEPCTL & (0x3UL << (18U))) == (0x1UL << (18U))) {
                     
                    if (get_frame() & 1) {
                        (epo->DOEPCTL) = ((epo->DOEPCTL) | ((0x1UL << (28U))));
                    } else {
                        (epo->DOEPCTL) = ((epo->DOEPCTL) | ((0x1UL << (29U))));
                    }
                } else if ((epi->DIEPCTL & (0x3UL << (18U))) == (0x1UL << (18U))) {
                     
                    if (get_frame() & 1) {
                        (epi->DIEPCTL) = ((epi->DIEPCTL) | ((0x1UL << (28U))));
                    } else {
                         (epi->DIEPCTL) = ((epi->DIEPCTL) | ((0x1UL << (29U))));
                    }
                }
            }
            OTG->GINTSTS = (0x1UL << (15U));
            return;
        } else {
...
static uint16_t get_serialno_desc(void *buffer) {
    ...
    fnv = fnv1a32_turn(fnv, *(uint32_t*)(0x1FFF7A10UL + 0x00));
    fnv = fnv1a32_turn(fnv, *(uint32_t*)(0x1FFF7A10UL + 0x04));
    fnv = fnv1a32_turn(fnv, *(uint32_t*)(0x1FFF7A10UL + 0x08));
    for (int i = 28; i >= 0; i -= 4 ) {
        uint16_t c = (fnv >> i) & 0x0F;
        c += (c < 10) ? '0' : ('A' - 10);
        *str++ = c;
    }
    dsc->bDescriptorType = 0x03;
    dsc->bLength = 18;
    return 18;
}
