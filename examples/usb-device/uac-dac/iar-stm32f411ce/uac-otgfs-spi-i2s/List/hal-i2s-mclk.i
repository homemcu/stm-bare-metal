...
void hal_i2s_mclk_init(void)
{
	...
	hw_cfg_pin(((GPIO_TypeDef*)(((0x40000000UL + 0x00020000UL) + 0x0000UL) + (0) * (((0x40000000UL + 0x00020000UL) + 0x0400UL)-((0x40000000UL + 0x00020000UL) + 0x0000UL)))), 0, (2 << 4) | 1 | (3 << 7) | (0 << 6) | (0 << 9));

	__NVIC_SetPriority(TIM2_IRQn, NVIC_EncodePriority(__NVIC_GetPriorityGrouping(), 6, 0));
}
...
void hal_i2s_mclk_start_count(void)
{
	...
	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->CNT = 0;
	
	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->SMCR = (0x1UL << (14U)) | (0x1UL << (4U)) | (0x4UL << (0U)) | (0x2UL << (0U));
	
	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->OR = (0x2UL << (10U));
	
	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->DIER = (0x1UL << (6U));
	
	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->CR1 = (0x1UL << (0U));
...
void hal_i2s_mclk_stop_count(void)
{
	...
	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->SMCR = 0;
	
	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->CR1 = 0;
}


_Pragma("object_attribute = __weak") void mclk_irq_callback(uint32_t mclk)
{
}
...
void TIM2_IRQHandler(void)
{
	...
	count = ((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->CNT;
	sr = ((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->SR;
	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->SR = 0;
	...
	if (sr & (0x1UL << (6U)))
	{
		if (count)
		{
			...
			{
				mclk += 0xffffffffU - mclk_count + count;
			}
