...
void usbd_hw_init(usbd_device *dev)
{
	...
	hw_cfg_pin(((GPIO_TypeDef*)(((0x40000000UL + 0x00020000UL) + 0x0000UL) + (0) * (((0x40000000UL + 0x00020000UL) + 0x0400UL)-((0x40000000UL + 0x00020000UL) + 0x0000UL)))),  11,  (2 << 4) | 10 | (3 << 7) | (0 << 6) | (0 << 9));
	hw_cfg_pin(((GPIO_TypeDef*)(((0x40000000UL + 0x00020000UL) + 0x0000UL) + (0) * (((0x40000000UL + 0x00020000UL) + 0x0400UL)-((0x40000000UL + 0x00020000UL) + 0x0000UL)))),  12,  (2 << 4) | 10 | (3 << 7) | (0 << 6) | (0 << 9));

	__NVIC_SetPriority(OTG_FS_IRQn, NVIC_EncodePriority(__NVIC_GetPriorityGrouping(), 14, 0));
