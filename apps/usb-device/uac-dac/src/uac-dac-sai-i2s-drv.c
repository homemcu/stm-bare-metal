...
// Byte sequence after this function before DMA transfer:    B1 B2 B3 B4
...
const audio_out_drv_t audio_out_drv =
{
	init,
	init_dma_txbuf,
	hal_sai_i2s_write_dma_buf,
	hal_sai_i2s_get_mclk,
