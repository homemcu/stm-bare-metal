...
//============================================
// Example 1:
// This main function formats the SD card and creates a readme.txt file
//============================================
#if 0
...
{
	FRESULT res;
	uint8_t wtext[] = "This is MCU working with FatFs";
	uint32_t byteswritten;

	platform_init();

    printf("Please wait for operations complete.\nThis may take several tens of seconds...\n");
	...
	res = f_mkfs("", FM_ANY, 0, buffer, sizeof(buffer));
	if (res != FR_OK)
	{
		error();
	}
	...
	{
	    printf("The SD card was successfully formatted.\n");
	}
	res = f_open(&MyFile, "readme.txt", FA_CREATE_ALWAYS | FA_WRITE);
	if (res != FR_OK)
	{
		error();
	}
	...
	{
	    printf("The readme.txt file was successfully created.\n");
	}
	...
	{
	    printf("The readme.txt file was successfully changed.\n");
	}
	f_close(&MyFile);
...
//============================================
// Example 2:
// Low level disk I/O module function checker (C)ChaN
//============================================
#if 1
