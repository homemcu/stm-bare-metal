...
#if I2S_MCLK == 1
	hw_cfg_pin(GPIOx(PORT_MCLK), PIN_MCLK, GPIOCFG_MODE_ALT | GPIO_AF10_SAI2 | GPIOCFG_OSPEED_HIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_NONE);
#endif
}
