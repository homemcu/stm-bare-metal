...
//--------------------------------------------
// Asynchronous static memories: Mode 2 - NOR Flash

#define FSMC_BANK1_SUBBANK       4UL // FSMC_NE4 is used
#define FSMC_BCR        FSMC_Bank1->BTCR[((FSMC_BANK1_SUBBANK - 1) * 2)]
#define FSMC_BTR        FSMC_Bank1->BTCR[((FSMC_BANK1_SUBBANK - 1) * 2 + 1)]
#define FSMC_BWTR       FSMC_Bank1E->BWTR[(FSMC_BANK1_SUBBANK - 1)]
// HADDR[27:26] = FSMC_BANK1_SUBBANK - 1
// Memory width  |  Data address issued to the memory
// 8-bit         |  HADDR[25:0]
// 16-bit        |  HADDR[25:1] >> 1
#define ADDR_PIN_MASK   (0x1UL << (6 + 1)) // FSMC_A6 is used
#define ADDR_REG        (0x60000000UL + ((FSMC_BANK1_SUBBANK - 1) << 26))                  // PIN_A6 = 0 (command)
#define ADDR_DATA       (0x60000000UL + ((FSMC_BANK1_SUBBANK - 1) << 26) + ADDR_PIN_MASK)  // PIN_A6 = 1 (data)
...
void hal_ili9341_init(void)
{
	...
	hw_cfg_pin(GPIOx(PORT_D0),   PIN_D0,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D1),   PIN_D1,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D2),   PIN_D2,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D3),   PIN_D3,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D4),   PIN_D4,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D5),   PIN_D5,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D6),   PIN_D6,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D7),   PIN_D7,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D8),   PIN_D8,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D9),   PIN_D9,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D10),  PIN_D10,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D11),  PIN_D11,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D12),  PIN_D12,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D13),  PIN_D13,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D14),  PIN_D14,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_D15),  PIN_D15,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_NWE),  PIN_NWE,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_NOE),  PIN_NOE,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_NE4),  PIN_NE4,  GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	hw_cfg_pin(GPIOx(PORT_A6),   PIN_A6,   GPIOCFG_MODE_ALT | GPIO_AF12_FSMC | GPIOCFG_OSPEED_VHIGH | GPIOCFG_OTYPE_PUPD | GPIOCFG_PUPD_PUP);
	...
	// WAITPOL = 0
	// WRAPMOD = 0
	// WREN = 1: Write operations are enabled for the bank by the FSMC
	// WAITEN = 0
	// EXTMOD = 0: Mode 2
	// ASYNCWAIT = 0
	// CBURSTRW = 0
