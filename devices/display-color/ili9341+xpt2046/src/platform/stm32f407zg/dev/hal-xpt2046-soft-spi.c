...
//--------------------------------------------
#define	PORT_SCK        GPIO_B // PB0  --> T_SCK(T_CLK)
#define	PIN_SCK         0
#define	PORT_CS         GPIO_C // PC13 --> T_CS(T_CS)
#define	PIN_CS          13
#define	PORT_MOSI       GPIO_F // PF11 --> T_MOSI(T_DIN)
#define	PIN_MOSI        11
#define	PORT_MISO       GPIO_B // PB2  <-- T_MISO(T_DO)
#define	PIN_MISO        2
#define	PORT_INT        GPIO_B // PB1  <-- T_PEN(T_IRQ)
#define	PIN_INT         1
